...
The studio is hosted at [mkk.sanity.studio](https://mkk.sanity.studio) and manages content for the club's website ([frontend repo here](https://github.com/malmoklatterklubb/mkk-astro)).
...
- A Sanity account with access to project `dajcvves`
